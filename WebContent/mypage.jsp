						...
						<fieldset>
							...
							<ul class="reg_list">
								<li class="clear">
									...
									<div class="reg_content">${name }</div>
								</li>
								<li class="clear">
									<label class="tit_lbl">비밀번호</label>
									<div class="reg_content">${pass }</div>
								</li>
								<li class="clear">
									<label class="tit_lbl">성별</label>
									<div class="reg_content">${sex }</div>
								</li>
								
								<li class="clear">
									<span class="tit_lbl">연락처</span>
									<div class="reg_content">${tel }</div>
								</li>
								<li class="clear">
								...
								<li class="clear">
									...
									<div class="reg_content">${email1 }@${email2 }</div>
								</li>
								<li class="clear">
							...
							<div class="app_content"><textarea id="content_lbl" value="${content }" name="content" class="w100p" placeholder="간단한 상담 요청 사항을 남겨주시면 보다 상세한 상담이 가능합니다.
전화 상담 희망시 기재 부탁드립니다."></textarea></div>
						</li>
							</ul>
							<p class="btn_line"><a href="login.jsp" class="btn_baseColor">확인</a>
							<a href="joinDelete.do?email1=${email1 }&email2=${email2 }" class="btn_baseColor">수정</a></p>	
